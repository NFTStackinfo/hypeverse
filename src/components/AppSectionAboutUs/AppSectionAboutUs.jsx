...
function AppSectionAboutUs(props) {
    const paragraphs = [
        'Hypeverse represents the synergy between the world of fashion and digital ownership. When buying a Hypeverse you are not only owning a digital collectible but also gaining access to the forefront of evolution in the fashion industry in the metaverse. We are going to create exclusive digital collections with well-known clothing brands reserved for Hypeverse holders.',
